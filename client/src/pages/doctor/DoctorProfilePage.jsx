...
function DoctorProfilePage() {
  ...
  const finalAvatar =
    getFullAvatarPath(user?.anhDaiDien) ||
    `https://ui-avatars.com/api/?name=${encodeURIComponent(doctor?.tenBacSi || "BS")}&size=200&background=f8fafc&color=94a3b8`;
        ...
        <section className="bg-white border-2 border-slate-100 rounded-4xl p-8 text-center shadow-sm">
          ...
          <div className="mt-6 space-y-2">
            ...
            <p className="text-primary font-bold text-[11px] uppercase tracking-widest">
              {doctor?.hocViChucDanh || "Bác sĩ Chuyên khoa"}
            </p>
          </div>
        ...
        <section className="bg-white border-2 border-slate-100 rounded-4xl p-8 sm:p-12 space-y-12">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <ProfileDetailItem
                label="Chuyên khoa trực thuộc"
                value={doctor?.chuyenKhoa?.tenChuyenKhoa}
                icon="stethoscope"
              />
            </div>
          </div>
