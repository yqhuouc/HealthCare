/**
 * ============================================================
 * TRANG: Thêm chuyên khoa mới (Admin)
 * Đường dẫn: /admin/specialties/add
 * ============================================================
 *
 * Chức năng:
 * - Form thêm chuyên khoa: tên, icon (dropdown Material Symbols), mô tả
 * - Preview icon đã chọn ngay bên dưới dropdown
 * - Validate: bắt buộc nhập tên chuyên khoa
 * - Breadcrumb: Quản lý chuyên khoa / Thêm chuyên khoa
 * - Nút "Lưu chuyên khoa" → toast thành công → quay về /admin/specialties
 *
 * State:
 * - form: { name, icon, description }
 *
 * Dữ liệu: ICON_OPTIONS (danh sách icon Material Symbols cho dropdown)
 * ============================================================
 */
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-2 mb-6 text-sm">
        ...
        <span className="text-slate-900 font-medium">Thêm chuyên khoa</span>
      </div>
