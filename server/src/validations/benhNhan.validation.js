...
const createBenhNhanSchema = z.object({
  hoTen: z.string().min(1, "Họ tên là bắt buộc").max(120, "Họ tên tối đa 120 ký tự"),
  soDienThoai: z.string().max(20, "Số điện thoại tối đa 20 ký tự").optional().nullable(),
  emailLienHe: z.string().email("Email liên hệ không hợp lệ").optional().or(z.literal("")).nullable(),
});

module.exports = { updateBenhNhanSchema, createBenhNhanSchema };
